...
class Metadata {
  ...
  getConnection(){
    return this.adpater.getConnection();
  }

  *batch(scripts){
    return yield this.adapter.batch(scripts);
  }
  ...
  *execute(sql, params, options){
	...
	generateSelect(args, cols, extra, primaryKeyOnly){
		var where = this.generateWhere(args, primaryKeyOnly);
		var colStr = '';
